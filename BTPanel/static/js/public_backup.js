        ...
        bt.send('GetSoftList', 'ajax/GetSoftList', {}, function(l) {
            ...
            for (var h = 0; h < l.length; h++) {
                ...
                for (var b = 0; b < l[h].versions.length; b++) {
                    var d = "";
                    if ((l[h].name == "PHP" && (l[h].versions[b].version == "7.4" || l[h].versions[b].version == "7.4")) || (l[h].name == "MySQL" && l[h].versions[b].version == "5.6") || (l[h].name == "phpMyAdmin" && l[h].versions[b].version == "5.0")) {
                        d = "selected";
...
bt.files = {
        ...
        del_recycle_bin: function(path, callback) {
            bt.prompt_confirm(lan.files.recycle_bin_del_title, '您确定要删除文件['+ path +']吗，该操作将<span style="color:red;">永久删除该文件</span>，是否继续操作？', function () {
...
bt.soft = {
  ...
  product_pay_view: function (config) {
    ...
    if (pro_end === '0' && (config.limit === 'pro' || config.limit === 'ltd')) {
      bt.msg({
        msg: '您当前【专业版】为永久授权，请通过官网解绑后重新操作 <a href="#" target="_blank" class="btlink ml5">《立即前往》</a>',
        icon: 7,
        time: 0,
        shade: [0.3, "#000"]
      })
      ...
      content: '<div class="libPay-content-box">\
                ...
                <div id="pay_product_view">\
                    ...
                    <div class="libPay-layer-item">\
                        ...
                        <div class="libPay-footer-tips"><p>温馨提醒：所有不在堡塔付款的产品100%是骗人的，请勿上当。<a class="btlink" href="#" target="_blank">查看详情</a></p><p>支付异常请联系客服QQ：<a class="btlink" href="https://wpa1.qq.com/OUMbED4a?_type=wpa&qidian=true" target="_blank">3007255432</a></p></div>\
                    </div>\
                    <div class="libPay-layer-item">\
  ...
  get_product_discount_cache: function (config, callback) {
    ...
    updata_ltd: function(is_alone) {
        var param = { name: '面板企业版', pid: 100000032, limit: 'ltd' };
