...
{
    listen 80;
    server_name huang.hostpanel.cn bt001.hostpanel.cn;
    index index.php index.html index.htm default.php default.htm default.html;
    root /www/wwwroot/huang.hostpanel.cn;
    ...
    include /www/server/panel/vhost/rewrite/huang.hostpanel.cn.conf;
    #REWRITE-END
    ...
    access_log  /www/wwwlogs/huang.hostpanel.cn.log;
    error_log  /www/wwwlogs/huang.hostpanel.cn.error.log;
};'''
    ...
    def _generate_nginx_conf(self,siteName):
        ...
        siteConfig = {
	                    ...
	                    "proxy": {
		                    "open": False,
		                    "url": "http://www.hostpanel.cc",
		                    "host": "www.hostpanel.cc",
		                    "subOpen": False,
		                    "src": "",
		                    "dst": "",
		                    "cache": False
	                    ...
	                    "antiStealingLink": {
		                    ...
		                    "domains": ["www.hostpanel.cc", "hostpanel.cn"],
		                    "code": 404
	                    },
	                    "networkLimit": {
		                    "open": False,
